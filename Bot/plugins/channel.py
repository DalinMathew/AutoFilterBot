...
async def connect(bot: Bot, update):
    ...
    try:
        ...
        print(f"{skipCT} Files Been Skipped Due To File Name Been None..... #BlameTeleGram")
    except Exception as e:
...
async def disconnect(bot: Bot, update):
    ...
    wait_msg = await update.reply_text("Deleting All Files Of This Channel From DataBase....!!!\n\nPlease Be Patience...Dont Sent Another Command Until This Process Finishes..")
    ...
    await wait_msg.edit_text("Sucessfully Deleted All Files From DataBase....")

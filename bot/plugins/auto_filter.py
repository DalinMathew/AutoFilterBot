    ...
    if len(results) == 0: # double check
        ...
        try:
            await bot.send_photo(
                ...
                photo = "https://telegra.ph/file/a5df0b4e83cdcca08b918.jpg"
                caption=f"⚜️ Check Links at @MalRok..  ⚜️   Found <code>{leng}</code> Results For Your Request: <code>{query}</code> 😎",
